"""
Django settings for zagadki project.
...
SECRET_KEY = 'django-insecure-b+skt4kepj(96p7!*j$kyl+1qm-8u5$lxr=d_+8)2!_5=jjf$y'
...
WSGI_APPLICATION = 'zagadki.wsgi.application'
